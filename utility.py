...
def symplectic_standing(standing_children, tf):
    ...
    while t <= tf:
        ...
        if (phi >= 0 and standing[1][counter-1] < 0) or (phi <= 0 and standing[1][counter-1] > 0):
            w = (lsquat/lstand)**2 * standing[2][counter-1]
            #print("salto")


        if (w >= 0 and standing[2][counter-1] < 0) or (w <= 0 and standing[2][counter-1] > 0):
            w = (lstand/lsquat)**2 * standing[2][counter-1]
...
def plot_():
    ...
    plt.scatter(standing[1], standing[2], s=10, c='r', marker='o')

    ax1 = plt.subplot(2, 1, 2)
    #plt.grid(color='gray', linestyle='solid')
    ax1.set_xlabel(r'$time (s)$', fontsize=12)
    ax1.set_ylabel(r'$phi (rad)$', fontsize=12,labelpad = 25, rotation=0)
    plt.scatter(standing[0], standing[1], s=10, c='r', marker='o')
    ...
    ax1.set_xlabel(r'$phi (rad)$', fontsize=12)
    ax1.set_ylabel(r'$w (rad/s)$', fontsize=12, labelpad = 25, rotation=0)
    plt.scatter(seated[1], seated[2], s=10, c='r', marker='o')

    ax1 = plt.subplot(2, 1, 2)
    #plt.grid(color='gray', linestyle='solid')
    ax1.set_xlabel(r'$time (s)$', fontsize=12)
    ax1.set_ylabel(r'$phi (rad)$', fontsize=12,labelpad = 25, rotation=0)
    plt.scatter(seated[0], seated[1], s=10, c='r', marker='o')
...
def plotrealistic():
    ...
    ax1.set_xlabel(r'$phi (rad)$', fontsize=12)
    ax1.set_ylabel(r'$w (rad/s)$', fontsize=12, labelpad = 25, rotation=0)
    plt.scatter(realistic[1], realistic[2], s=10, c='r', marker='o')

    ax1 = plt.subplot(2, 1, 2)
    #plt.grid(color='gray', linestyle='solid')
    ax1.set_xlabel(r'$time (s)$', fontsize=12)
    ax1.set_ylabel(r'$phi (rad)$', fontsize=12,labelpad = 25, rotation=0)
    plt.scatter(realistic[0], realistic[1], s=10, c='r', marker='o')
